                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="text-xs flex items-center gap-1 text-[#0891B2] hover:text-[#0891B2]/80 disabled:opacity-50"
                    >
                      <Sparkles className="w-3 h-3" />
                      {selectedContact.isLoadingSummary ? 'Generating...' : selectedContact.summary ? 'Done' : 'Generate'}
                    </button>
                  </div>
